...
In this section we show the plots as returned by `apply_gam()`. Folder: [`./data/output/GAM_outputs`](https://github.com/b-cubed-eu/raccoon/tree/main/data/output/GAM_outputs).
...
We show and save plots with the species only as title. We save them in sub folder [`./data/output/GAM_outputs/short_title`](https://github.com/b-cubed-eu/raccoon/tree/main/data/output/GAM_outputs/short_title).
...
For each country, we can show the plots of the number of occurrences and the measured occupancy next to each other. Plots saved in subfolder [`./data/output/GAM_outputs/plots_for_countries`](https://github.com/b-cubed-eu/raccoon/tree/main/data/output/GAM_outputs/plots_for_countries).
